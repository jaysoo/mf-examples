...
test.describe('standalone remotes (vite)', () => {
  for (const { port, name, file } of [
    { port: 5101, name: 'remote-1 standalone', file: '05-standalone-remote-1' },
    { port: 5102, name: 'remote-2 standalone', file: '06-standalone-remote-2' },
    { port: 5103, name: 'remote-3 standalone', file: '07-standalone-remote-3' },
  ]) {
